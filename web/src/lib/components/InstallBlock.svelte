<!--
  @component
  Install flow: generate API key, show install command, manage existing keys.
...
{#if prominent}
  ...
  <div class="install-hero">
    <div class="hero-header">
      ...
      <span class="hero-subtitle">Install the Savecraft daemon on your machine</span>
    </div>
    ...
    <Panel>
      <div class="section">
        ...
        {:else}
          <p class="step-desc">
            The daemon uses an API key to authenticate with Savecraft. Generate one to get started.
          </p>
      ...
      <div class="section">
        ...
        {#if generatedKey}
          ...
          <div class="command-block">
            <code class="command-text">{installCommand(currentKey)}</code>
            <TinyButton
              label={copied === "cmd" ? "COPIED" : "COPY"}
              onclick={() => {
                void copyToClipboard(installCommand(currentKey), "cmd");
              }}
            />
          </div>
        {:else}
          <p class="step-desc step-disabled">
            Generate an API key first, then the install command will appear here.
          </p>
        {/if}
      </div>
    </Panel>
    ...
    {#if expanded}
      <div class="compact-install">
        <div class="section">
          ...
          {:else}
            <p class="step-desc">Generate a key, then run the install command on your machine.</p>
            <div class="action-row">
              <TinyButton
                label={loading ? "GENERATING..." : "GENERATE KEY"}
                onclick={generate}
        ...
        {#if generatedKey}
          ...
          <div class="section">
            <div class="step-header">
              <span class="step-title">Install Command</span>
            </div>
            <div class="command-block">
              <code class="command-text">{installCommand(currentKey)}</code>
              <TinyButton

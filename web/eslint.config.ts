...
export default tseslint.config(
  ...
  // ── All TypeScript + Svelte files ─────────────────────────
  {
    ...
    rules: {
      ...
      // ── Unicorn overrides ─────────────────────────────────
      "unicorn/no-null": "off", // null is idiomatic in Web APIs and DOM
  ...
  // ── Svelte-specific relaxations ───────────────────────────
  {
    files: ["**/*.svelte"],
    rules: {
      // Svelte components use PascalCase filenames
      "unicorn/filename-case": "off",
      // Svelte reactive declarations are expressions
      "@typescript-eslint/explicit-function-return-type": "off",
      // Svelte component scripts often exceed 80 lines
      "max-lines-per-function": "off",
      // $props() and $derived() require `let` — Svelte 5 convention
      "prefer-const": "off",
      // SvelteKit layout children and $props() / $derived() can be implicitly any

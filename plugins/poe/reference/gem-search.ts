...
export const gemSearchModule: NativeReferenceModule = {
  ...
  description: [
    ...
    "Canonical source for gem names used by build_planner's swap_gem and add_gem",
    "operations — call this before those ops if you're unsure of an exact name.",
    "PoB canonical names OMIT the trailing ' Support' (e.g. 'Added Lightning Damage',",
    "not 'Added Lightning Damage Support'); build_planner handles the alias but",
    "naming them correctly avoids the round-trip.",

...
// Rune and gem item code constants are defined in tables_items.go.

// socketablesWeapons maps gem/rune item codes to the magical properties they
// grant when socketed into a weapon.
var socketablesWeapons = map[string][]MagicAttribute{
	// Runes
	ElRune: {
		{ID: 19, Name: "+{0} to Attack rating", Values: []int64{50}},
		{ID: 89, Name: "+{0} to Light Radius", Values: []int64{1}},
	},
	EldRune: {
		{ID: 122, Name: "+{0}% Damage to Undead", Values: []int64{75}},
		{ID: 124, Name: "+{0} to Attack Rating against Undead", Values: []int64{50}},
	},
	...
	IthRune: {
		{ID: 22, Name: "+{0} to Maximum 1-handed damage", Values: []int64{9}},
		{ID: 24, Name: "+{0} to Maximum 2-handed damage", Values: []int64{9}},
	},
	...
	SolRune: {
		{ID: 21, Name: "+{0} to Minimum 1-handed damage", Values: []int64{9}},
		{ID: 23, Name: "+{0} to Minimum 2-handed damage", Values: []int64{9}},
	},
	...
	PulRune: {
		{ID: 121, Name: "+{0}% Damage to Demons", Values: []int64{75}},
		{ID: 123, Name: "+{0} to Attack Rating against Demons", Values: []int64{100}},
	},
	...
	// Skull
	ChippedSkull: {
		{ID: 60, Name: "{0}% Life Stolen Per Hit", Values: []int64{2}},
		{ID: 62, Name: "{0}% Mana Stolen Per Hit", Values: []int64{1}},
	},
	FlawedSkull: {
		{ID: 60, Name: "{0}% Life Stolen Per Hit", Values: []int64{2}},
		{ID: 62, Name: "{0}% Mana Stolen Per Hit", Values: []int64{2}},
	},
	Skull: {
		{ID: 60, Name: "{0}% Life Stolen Per Hit", Values: []int64{3}},
		{ID: 62, Name: "{0}% Mana Stolen Per Hit", Values: []int64{2}},
	},
	FlawlessSkull: {
		{ID: 60, Name: "{0}% Life Stolen Per Hit", Values: []int64{3}},
		{ID: 62, Name: "{0}% Mana Stolen Per Hit", Values: []int64{3}},
	},
	PerfectSkull: {
		{ID: 60, Name: "{0}% Life Stolen Per Hit", Values: []int64{4}},
		{ID: 62, Name: "{0}% Mana Stolen Per Hit", Values: []int64{3}},
	},
...
// socketablesArmor maps gem/rune item codes to the magical properties they
// grant when socketed into armor (body armor, helms, boots, gloves, belts).
var socketablesArmor = map[string][]MagicAttribute{
	ElRune: {
		{ID: 31, Name: "+{0} Defense", Values: []int64{15}},
		{ID: 89, Name: "+{0} to Light Radius", Values: []int64{1}},
	},
	...
	UmRune: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{15}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{15}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{15}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{15}},
	},
	...
	// Skull
	ChippedSkull: {
		{ID: 74, Name: "Replenish Life +{0}", Values: []int64{2}},
		{ID: 27, Name: "Regenerate Mana {0}%", Values: []int64{8}},
	},
	FlawedSkull: {
		{ID: 74, Name: "Replenish Life +{0}", Values: []int64{3}},
		{ID: 27, Name: "Regenerate Mana {0}%", Values: []int64{8}},
	},
	Skull: {
		{ID: 74, Name: "Replenish Life +{0}", Values: []int64{3}},
		{ID: 27, Name: "Regenerate Mana {0}%", Values: []int64{12}},
	},
	FlawlessSkull: {
		{ID: 74, Name: "Replenish Life +{0}", Values: []int64{4}},
		{ID: 27, Name: "Regenerate Mana {0}%", Values: []int64{12}},
	},
	PerfectSkull: {
		{ID: 74, Name: "Replenish Life +{0}", Values: []int64{5}},
		{ID: 27, Name: "Regenerate Mana {0}%", Values: []int64{19}},
	},
...
// socketablesShields maps gem/rune item codes to the magical properties they
// grant when socketed into a shield.
var socketablesShields = map[string][]MagicAttribute{
	...
	PulRune:   {{ID: 16, Name: "+{0}% Enhanced Defense", Values: []int64{30}}},
	UmRune: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{22}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{22}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{22}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{22}},
	},
	MalRune:  {{ID: 35, Name: "Magic Damage Reduced by {0}", Values: []int64{7}}},
	IstRune:  {{ID: 80, Name: "{0}% Better Chance of Getting Magic Items", Values: []int64{25}}},
	GulRune:  {{ID: 46, Name: "+{0}% to Maximum Poison Resist", Values: []int64{5}}},
	...
	// Diamond
	ChippedDiamond: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{6}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{6}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{6}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{6}},
	},
	FlawedDiamond: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{8}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{8}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{8}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{8}},
	},
	Diamond: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{11}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{11}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{11}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{11}},
	},
	FlawlessDiamond: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{14}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{14}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{14}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{14}},
	},
	PerfectDiamond: {
		{ID: 39, Name: "Fire Resist +{0}%", Values: []int64{19}},
		{ID: 41, Name: "Lightning Resist +{0}%", Values: []int64{19}},
		{ID: 43, Name: "Cold Resist +{0}%", Values: []int64{19}},
		{ID: 45, Name: "Poison Resist +{0}%", Values: []int64{19}},
	},

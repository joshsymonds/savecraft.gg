...
CREATE TABLE IF NOT EXISTS magic_card_rulings (
...
CREATE INDEX IF NOT EXISTS idx_card_rulings_oracle ON magic_card_rulings(oracle_id);
CREATE INDEX IF NOT EXISTS idx_card_rulings_name ON magic_card_rulings(card_name);
...
CREATE VIRTUAL TABLE IF NOT EXISTS magic_card_rulings_fts USING fts5(
  oracle_id UNINDEXED,
  card_name,
  comment,
  tokenize='porter unicode61'

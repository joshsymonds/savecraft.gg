...
ALTER TABLE magic_draft_ratings ADD COLUMN ata_stddev REAL NOT NULL DEFAULT 0;
ALTER TABLE magic_draft_color_stats ADD COLUMN ata_stddev REAL NOT NULL DEFAULT 0;
